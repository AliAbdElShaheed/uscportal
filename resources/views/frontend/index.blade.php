...
@push('scripts')
    ...
    <div class="sidebar-popup" id="popupContainer">
        <div class="popup-content">
            ...
            <p dir="RTL"
               style='margin-right:0in;margin-left:0in;font-size:16px;font-family:"Calibri",sans-serif;margin-top:0in;margin-bottom:8.0pt;font-size:11.0pt;text-align:center;background:white;'>
