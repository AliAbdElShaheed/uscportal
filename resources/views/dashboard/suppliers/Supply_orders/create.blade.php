    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('orders.index')}}"> @lang('site.supply_orders')</a></li>
                <li class="active"> @lang('site.add_supply_order')</li>
            </ol>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">@lang('site.add_new_supply_order')</h3>
                        </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href=""
                                                                               ...
                                                                               class="btn btn-success btn-sm add-purchase-product-btn">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="{{ route('supply_order.store', $supplier->id) }}"
                                          method="post">
                                        ...
                                        <button class="btn btn-primary btn-block disabled"
                                                id="add-supply_order-form-btn"><i
                                                class="fa fa-plus"></i> @lang('site.add_supply_order')</button>
                            ...
                            {{-- To Show Orders History OF This supplier--}}{{--
