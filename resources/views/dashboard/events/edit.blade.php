    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> @lang('site.edit_event')</li>
            </ol>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">@lang('site.edit_event')</h3>
                                </div>
                                <!-- /.card-header -->
                                @include('partials._errors')

                                {{--{{dd($event->publish_date)}}--}}
                                <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="content" class="form-control ckeditor"
                                                      id="exampleInputDesc">{{ $event->getTranslation('content', 'en') }}
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="content_ar" class="form-control ckeditor"
                                                      id="exampleInputDescAr">{{ $event->getTranslation('content', 'ar') }}
                                            </textarea>
                                        </div>
