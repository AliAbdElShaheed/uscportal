...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.orders')
                <small>all @lang('site.orders') starts here {{ $orders->total() }} </small>
            </h1>
                            ...
                            <div class="box-body table-responsive">
                                ...
                                <table class="table table-hover">
                                    <tr>
                                        ...
                                        <th>@lang('site.delivery_officer')</th>
                                        <th>@lang('site.transportation')</th>
                                        <th>@lang('site.transportation_number')</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (auth()->user()->hasPermission('orders_update'))
                                                    <a href="{{ route('order.edit', ['order' => $order->id,'client' => $order->client->id]) }}"
