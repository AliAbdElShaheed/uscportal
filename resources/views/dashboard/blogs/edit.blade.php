    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> @lang('site.edit_blog')</li>
            </ol>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">@lang('site.edit_blog')</h3>
                                </div>
                                <!-- /.card-header -->
                                @include('partials._errors')

                                {{--{{dd($blog->publish_date)}}--}}
                                <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="content" class="form-control ckeditor"
                                                      id="exampleInputDesc">{{ $blog->getTranslation('content', 'en') }}
                                            </textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="content_ar" class="form-control ckeditor"
                                                      id="exampleInputDescAr">{{ $blog->getTranslation('content', 'ar') }}
                                            </textarea>
                                        </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class=" form-check">
                                            <input class="form-check-input" type="radio" name="top_news"
                                                   id="exampleRadios1"
                                                   value="0" {{$blog->top_news == 0 ? "checked" : ""}}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="top_news"
                                                   id="exampleRadios2"
                                                   value="1" {{$blog->top_news == 1 ? "checked" : ""}}>
