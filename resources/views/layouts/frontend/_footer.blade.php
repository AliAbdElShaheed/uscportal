@if(app()->getLocale() == 'ar')
    <div class="footer pt-5 text-white-50 text-center text-md-end">
        @else
                    ...
                    <div class="row">
                                ...
                                <ul class="d-flex my-3 list-unstyled gap-3 justify-content-center justify-content-md-start">
                                    ...
                                    <li>
                                        <a class="d-block text-light"
                                           href="https://www.linkedin.com/company/university-of-sadat-city/"
                                        ><i class="fa-brands fa-linkedin fa-lg linkedin rounded-circle p-2"></i
                                            ></a>
                                    </li>
                                    <li>
                                        <a class="d-block text-light"
                                           href="https://www.instagram.com/universityofsadatcity/"
                                        ><i class="fa-brands fa-instagram fa-lg instagram rounded-circle p-2"></i
                                            ></a>
                                    </li>

                                    <li>
                                        <a class="d-block text-light" href="https://www.youtube.com/@U.S.C"
                        ...
                        <div class="col-md-6 col-lg-2">
                            <div class="links">
                                ...
                                <ul class="list-unstyled lh-lg">
                                    <li><a href="/about">@lang('front.about_university')</a></li>
                                    <li><a href="/management">@lang('front.university_management')</a></li>
                                    <li><a href="#">@lang('front.postgraduate_and_research')</a></li>
                                    <li><a href="/colleges">@lang('front.colleges_and_institutes')</a></li>
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="line">
                                ...
                                <div class="info">@lang('site.USCInfo')</div>
                            </div>
                            <div class="line">
                                <i class="far fa-clock fa-fw"></i>
                                <div class="info">@lang('site.BusinessHours')</div>
                            </div>
                            <div class="line">
             ...
             -->
                                    <div class="mapouter">
                                        <div class="gmap_canvas">
                                            <iframe
                                                src="https://maps.google.com/maps?q=university%20of%20sadat%20city&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
                                                frameborder="0" scrolling="no"
                                                style="width: 400px; height: 270px;"></iframe>
                                            <style>.mapouter {
                                                    position: relative;
                                                    height: 420px;
                                                    width: 200px
                ...
                <div class="copyright">
                    @lang('site.Created_By') <span>@lang('site.USC_Portal_Team') </span> &copy; 2023 -
                    @lang('site.All_rights_reserved') <span>@lang('site.USC') </span>
                </div>
            </div>
